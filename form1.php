...
fieldset{cursor: grabbing;width: 300px;padding: 15px;border-radius: 10px 10px;margin: auto;display: flex;flex-direction: column;align-items: center;justify-content: center;text-align: center;background-color: whitesmoke;border: 4px solid red;box-shadow: 7px 7px 7px black;}
...
input{text-align: left;text-shadow: 9px;padding: 4px;background-color: aliceblue;border: 4px solid blue;color: black;font-size: 16px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;font-style: oblique;cursor: crosshair;display: flex;flex-direction: column;;margin: auto;width: 300px;border-radius: 10px 10px;}
